...
function Stories() {
  const storyList = [
    { title: "Uzayın Derinlikleri", description: `Paris’te bir parkın ortasında, başını ellerine dayamış, derin düşüncelere dalmış bir figür: "Düşünen Adam." Dünyaca ünlü bu heykel, Auguste Rodin’in dehasının ve sanatın derin etkisinin bir simgesidir. Ancak "Düşünen Adam" sadece bir heykel değil; insan zihninin ve varoluşun karmaşıklığını anlatan bir öyküdür.
...
"Düşünen Adam," taşın içinden özgür bırakılmış bir ruhun simgesidir. O, bize düşünmenin, sorgulamanın ve insan olmanın ne anlama geldiğini hatırlatır. Bu heykel, zamanın ve mekanın ötesine geçen bir çağrı yapar: "Kim olduğunuzu ve neden burada olduğunuzu düşünün.`, image: "/space.jpg" },
